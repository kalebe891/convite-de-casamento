...
ALTER TABLE public.wedding_details ADD CONSTRAINT wedding_details_theme_id_check CHECK (theme_id IN ('legacy','editorial','minimal','modern-noir'));
...
BEGIN
  ...
  IF v_theme NOT IN ('legacy', 'editorial', 'minimal', 'modern-noir') THEN
    v_theme := 'legacy';
  END IF;
