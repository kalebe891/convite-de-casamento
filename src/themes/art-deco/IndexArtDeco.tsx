...
import HeroArtDeco from "@/components/wedding/HeroArtDeco";
...
/**
 * IndexArtDeco — Renderer raiz do tema "art-deco".
 *
 * Reaproveita seções padrão; apenas o Hero é exclusivo (HeroArtDeco).
 * Paleta aplicada via tokens [data-theme="art-deco"] injetados pelo ThemeRenderer.
 */
const IndexArtDeco = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center px-4">
          <h1 className="text-2xl text-foreground mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
