...
import HeroMinimal from "@/components/wedding/HeroMinimal";
...
/**
 * IndexMinimal — Renderer raiz do tema "minimal".
 *
 * Estruturalmente idêntico ao legacy/editorial, exceto pelo Hero (HeroMinimal).
 * Paleta minimal aplicada via tokens [data-theme="minimal"] injetados pelo
 * ThemeRenderer. Sem lógica de dados duplicada.
 */
const IndexMinimal = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center px-4">
          <h1 className="text-2xl font-sans text-foreground mb-2">Evento não encontrado</h1>
