...
import HeroBoho from "@/components/wedding/HeroBoho";
...
/**
 * IndexBoho — Renderer raiz do tema "boho".
 * Reaproveita seções padrão; apenas o Hero é exclusivo (HeroBoho).
 * Paleta aplicada via tokens [data-theme="boho"] injetados pelo ThemeRenderer.
 */
const IndexBoho = () => {
