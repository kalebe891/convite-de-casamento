...
const ShowcaseCard = ({ event }: Props) => {
  ...
  return (
    <Link
      to={url}
      className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-[hsl(var(--border)/0.55)] bg-card shadow-[0_1px_2px_hsl(0_0%_0%/0.04),0_8px_24px_-12px_hsl(var(--foreground)/0.12)] ring-1 ring-[hsl(var(--primary)/0.06)] transition-[transform,box-shadow,border-color] duration-300 ease-out will-change-transform hover:-translate-y-0.5 hover:border-[hsl(var(--primary)/0.45)] hover:shadow-[0_2px_4px_hsl(0_0%_0%/0.05),0_18px_40px_-18px_hsl(var(--primary)/0.28)]"
    >
